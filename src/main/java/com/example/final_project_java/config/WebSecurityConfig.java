      ...
      http
            ...
            .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                              ...
                              .requestMatchers(HttpMethod.PATCH, "/car/review").permitAll()
                              .requestMatchers(HttpMethod.DELETE, "/car/review/{id}").permitAll()
                              .requestMatchers(HttpMethod.POST, "/car/review").permitAll()
